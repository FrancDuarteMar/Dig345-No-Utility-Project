// const { config } = require("./steganography");
...
const getHidingCapacity = function (image, options) {
    options = options || {};
...
exports.encode = function(message, image, options) {
    // Handle image url
    var imageData = image
    // if(image.length) {
    ...
    // }
    // var imageData = shadowCtx.getImageData(0, 0, shadowCanvas.width, shadowCanvas.height),data = imageData.data;
